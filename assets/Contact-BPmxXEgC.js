import{o as r,F as j,i as y}from"./index-DuvGAO7y.js";import{r as g,g as s}from"./styles-cOqFwPJs.js";import"./vendor-COI1NATn.js";import"./icons-CHcfn-E7.js";function S(e){const o={};return e.name.trim()||(o.name="Nome é obrigatório."),e.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.email)||(o.email="E-mail inválido."):o.email="E-mail é obrigatório.",e.message.trim()||(o.message="Mensagem é obrigatória."),o}function v(){const[e,o]=g.useState({name:"",email:"",message:""}),[i,a]=g.useState({}),[t,l]=g.useState("idle");function b(c){const{name:n,value:d}=c.target;o(m=>({...m,[n]:d})),a(m=>({...m,[n]:void 0}))}async function $(c){c.preventDefault();const n=S(e);if(Object.keys(n).length>0){a(n);return}l("loading");try{await new Promise(d=>setTimeout(d,800)),l("success"),o({name:"",email:"",message:""})}catch{l("error")}}return{fields:e,errors:i,status:t,handleChange:b,handleSubmit:$}}const z=s.section`
