import{m as o,g as s,i as n,d as a,j as c}from"./index-Cy8zBjX7.js";import{g as e}from"./styles-cOqFwPJs.js";import"./vendor-COI1NATn.js";import"./icons-CHcfn-E7.js";const d=[{icon:s,title:"Desenvolvimento Web",description:"Sites institucionais, sistemas e aplicações web modernas, rápidas e acessíveis."},{icon:n,title:"Desenvolvimento Mobile",description:"Aplicativos iOS e Android nativos ou multiplataforma com foco em experiência do usuário."},{icon:a,title:"Design UI/UX",description:"Interfaces intuitivas e visualmente consistentes que convertem visitantes em clientes."},{icon:c,title:"Consultoria Digital",description:"Arquitetura de software, estratégia de produto e apoio técnico para seu negócio crescer."}],l=e.section`
...
`,h=e.p`
  ...
  line-height: 1.6;
  margin: 0;
`;function j(){return o.jsxs(l,{id:"servicos",children:[o.jsxs(p,{children:["Nossos ",o.jsx("span",{children:"Serviços"})]}),o.jsx(m,{children:"Soluções digitais do início ao fim, com tecnologia e atenção aos detalhes."}),o.jsx(g,{children:d.map(({icon:i,title:t,description:r})=>o.jsxs(x,{"data-testid":"service-card",children:[o.jsx(u,{"data-testid":"service-icon","aria-hidden":"true",children:o.jsx(i,{size:24})}),o.jsx(f,{"data-testid":"service-title",children:t}),o.jsx(h,{"data-testid":"service-description",children:r})]},t))})]})}export{j as default};
